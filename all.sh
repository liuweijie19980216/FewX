...
CUDA_VISIBLE_DEVICES=0,1 python3 fsod_train_net.py --num-gpus 2 \
	--config-file configs/fsod/R_50_C4_1x.yaml 2>&1 | tee log/scae_train_log.txt
...
rm support_dir/support_feature.pkl
CUDA_VISIBLE_DEVICES=0,1 python3 fsod_train_net.py --num-gpus 2 \
	--config-file configs/fsod/finetune_R_50_C4_1x.yaml 2>&1 | tee log/scae_finetune_log.txt
