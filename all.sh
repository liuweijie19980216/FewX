...
CUDA_VISIBLE_DEVICES=0,1 python3 fsod_train_net.py --num-gpus 2 \
	--config-file configs/fsod/R_50_C4_1x.yaml 2>&1 | tee log/meta_train_log.txt
...
rm support_dir/support_feature.pkl
CUDA_VISIBLE_DEVICES=0,1 python3 fsod_train_net.py --num-gpus 2 \
	--config-file configs/fsod/finetune_R_50_C4_1x.yaml 2>&1 | tee log/meta_finetune_log.txt
CUDA_VISIBLE_DEVICES=0,1 python3 fsod_train_net.py --num-gpus 2 \
	--config-file configs/fsod/finetune_R_50_C4_1x.yaml \
	--eval-only MODEL.WEIGHTS ./output/fsod/finetune_dir/R_50_C4_1x/model_final.pth 2>&1 | tee log/meta_test_log.txt
