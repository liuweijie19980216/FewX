...
class MetaBasicStem(CNNBlockBase):
    """
    The standard ResNet stem (layers before the first residual block).
    """
...
class ResNet(Backbone):
    ...
    def __init__(self, stem_rcnn, stem_meta, stages, num_classes=None, out_features=None):
        """
        Args:
...
def build_resnet_backbone(cfg):
    ...
    return ResNet(stem_rcnn, stem_meta, stages, out_features=out_features).freeze(freeze_at)
